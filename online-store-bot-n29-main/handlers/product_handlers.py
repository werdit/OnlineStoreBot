...
async def send_welcome(message: types.Message):
    await message.reply("Assalomu alaykum! Bu botda e'lonlar ro'yhatini ko'rish uchun /elonlar buyrug'ini kiriting.")

@dp.message_handler(commands=['elonlar'])
async def show_elonlar(message: types.Message):
    elonlar = ["E'lon 1", "E'lon 2", "E'lon 3"]
    formatted_elonlar = "\n".join(elonlar)
    await message.reply(f"E'lonlar ro'yhati:\n\n{formatted_elonlar}", parse_mode=ParseMode.MARKDOWN)
